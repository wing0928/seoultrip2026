...
const rawDays = [
  ...
  },
  {
    ...
    stops: [
      ...
      stop('d2-2', '12:00', '中午', '安國豬肉湯飯', '餐廳', '安國', '把豬肉湯飯安排成早午餐或午餐，暖胃又不會太趕。'),
      ...
      stop('d2-5', '18:30', '晚上', '仁寺洞 / 鐘路晚餐', '餐廳', '鐘路', '可找韓定食、煎餅或傳統茶館收尾。')
    ]
  },
  {
    id: 'day-3',
    ...
    stops: [
      ...
      stop('d3-3', '13:00', '中午', '聖水洞午餐', '餐廳', '聖水', '可選韓式餐廳、漢堡、義式或熱門排隊店。'),
      stop('d3-4', '15:00', '下午', '聖水選物店與品牌旗艦店', '選物店', '聖水', 'Tamburins、ADER、服飾選物與期間限定快閃都可放這段。'),
      stop('d3-5', '18:30', '晚上', '建大 / 聖水烤肉晚餐', '餐廳', '聖水', '把烤肉安排在這晚，移動少、吃完可以直接回住宿。')
    ]
  },
  {
    id: 'day-4',
    ...
    stops: [
      stop('d4-1', '10:30', '上午', '漢南洞小店散步', '選物店', '漢南', '選物店、服飾、香氛與生活風格店集中，適合慢逛。'),
      stop('d4-2', '12:30', '中午', '漢南洞午餐', '餐廳', '漢南', '可找熱門韓食、早午餐或排隊餐廳。'),
      stop('d4-3', '14:30', '下午', '梨泰院街區', '景點', '梨泰院', '順路逛古著、雜貨、咖啡廳，也能安排 Leeum 美術館。'),
      stop('d4-4', '17:00', '下午', '漢江公園', '景點', '漢江', '傍晚散步、便利商店買飲料，天氣好可看夕陽。'),
      stop('d4-5', '19:00', '晚上', '梨泰院晚餐', '餐廳', '梨泰院', '找異國料理或韓式小酒館，不排太晚。')
    ]
  },
  {
    id: 'day-5',
    ...
    stops: [
      ...
      stop('d5-2', '12:30', '中午', '延南洞午餐', '餐廳', '延南', '可找韓式家常、義式、日式或熱門排隊店。'),
      stop('d5-3', '15:00', '下午', '弘大商圈', '景點', '弘大', '服飾、美妝、唱片、文創小物，適合集中購物。'),
      stop('d5-4', '17:30', '下午', '弘大拍貼 / 街頭表演', '景點', '弘大', '拍貼機、街頭表演與年輕商圈氛圍很適合晚上。'),
      stop('d5-5', '19:30', '晚上', '弘大晚餐與宵夜', '餐廳', '弘大', '最後一個完整晚上，可以安排烤腸、炸雞或小酒館。')
    ]
  },
  {
    id: 'day-6',
